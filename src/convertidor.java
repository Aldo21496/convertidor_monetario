    ...
    public static void main(String[] arg){
        ...
        while (true) {
            try {
                ...
                switch (opcion) {
                    case 1:
                        url = "https://v6.exchangerate-api.com/v6/885f99d7c04e9d259dbcb0ae/pair/USD/ARS";
                        monedaOrigen = "USD";
                        monedaDestino = "ARS";
                        break;
                    case 2:
                        url = "https://v6.exchangerate-api.com/v6/885f99d7c04e9d259dbcb0ae/pair/ARS/USD";
                        monedaOrigen = "ARS";
                        monedaDestino = "USD";
                        break;
                    case 3:
                        url = "https://v6.exchangerate-api.com/v6/885f99d7c04e9d259dbcb0ae/pair/USD/BRL";
                        monedaOrigen = "USD";
                        monedaDestino = "BRL";
                        break;
                    case 4:
                        url = "https://v6.exchangerate-api.com/v6/885f99d7c04e9d259dbcb0ae/pair/BRL/USD";
                        monedaOrigen = "BRL";
                        monedaDestino = "USD";
                        break;
                    case 5:
                        url = "https://v6.exchangerate-api.com/v6/885f99d7c04e9d259dbcb0ae/pair/USD/COP";
                        monedaOrigen = "USD";
                        monedaDestino = "COP";
                        break;
                    case 6:
                        url = "https://v6.exchangerate-api.com/v6/885f99d7c04e9d259dbcb0ae/pair/COP/USD";
                        monedaOrigen = "COP";
                        monedaDestino = "USD";
                        break;
                }
